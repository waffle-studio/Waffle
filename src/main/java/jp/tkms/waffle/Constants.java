...
public class Constants {
  ...
  static final public String DEFAULT_PROJECT_DIR = "." + File.separator + "work" + File.separator + "project" + File.separator + "${NAME}";
  static final public String CONDUCTOR_TEMPLATE_DIR = "." + File.separator + "work" + File.separator + "conductor-template" + File.separator + "${NAME}";
  static final public String LISTENER_TEMPLATE_DIR = "." + File.separator + "work" + File.separator + "listener-template" + File.separator + "${NAME}";
